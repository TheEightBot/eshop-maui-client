...
The first step we will need to take is to bring our existing application's XAML and source code over. We will be specifically migrating the contents of the `eShopOnContainers.Core` project first, as this contains the bulk of our Xamarin.Forms application. Below is a list of all of the files and folders that we will migrate from this project.
